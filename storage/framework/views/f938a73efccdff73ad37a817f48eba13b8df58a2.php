...
<form method="post" action="<?php echo e(url('sale/adddevlivery')); ?>">
  ...
  <button type="submit" id="submit" class="btn btn-primary">Submit</button> <a href="<?php echo e(url('sale/deliverylisting/'.Request::segment(3).'/'.Request::segment(4))); ?>" class="btn btn-default">Back</a>
</form>
