<div class="row">
  <div class="col-md-4">
    ...
    <div class="form-group">
      ...
      <input type="text" name="piece_in_box" value="<?php echo e(old('piece_in_box',$item->pieces)); ?>" class="form-control" id="piece_in_box" aria-describedby="piece_in_box_msg" placeholder="Pieces Per Box">
    ...
    <div class="form-group">
      ...
      <input type="text" name="meter_per_box" value="<?php echo e(old('meter_per_box',$item->meter)); ?>" class="form-control" id="meter_per_box" aria-describedby="meter_per_box_msg" placeholder="Meter Per Box">
  ...
  <div class="col-md-4">
    ...
    <div class="form-group">
      ...
      <input type="number" name="purchase_price" value="<?php echo e(old('purchase_price',$item->purchase_price)); ?>" class="form-control" id="purchase_price" placeholder="Purchase Price" aria-describedby="purchase_price">
