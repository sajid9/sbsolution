...
<div class="row" style="margin-bottom: 10px">
	<div class="col-md-12">
		<form class="form-inline" method="post" action="<?php echo e(url('ledger/searchcustomer')); ?>">
			<?php echo csrf_field(); ?>
			    ...
			    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
			        ...
			        <tbody>
			        	...
			        	<tr>
			        		...
			        		<td><?php echo e($ledger->customer->customer_name); ?></td>
	    ...
	    $(document).ready(function() {
	        ...
	        $('[data-toggle="tooltip"]').tooltip();
	         $('.items-dropdown').select2({
	         	width: '200px',
	         	ajax: {
	         	    url: '<?php echo e(url("ledger/getcustomer")); ?>',
	         	    dataType: 'json',
...
<?php echo $__env->make('layout.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\sb_solution\resources\views/pages/customerledger/customer_ledger.blade.php ENDPATH**/ ?>