	...
	<table class="table table-striped table-bordered table-hover" id="dataTables-example1">
		...
		<tbody>
			...
			<tr class="odd gradeX">
				...
				<td>
					<a class="btn btn-xs btn-warning" type="button" class="" data-toggle="modal" data-target="#edit<?php echo e($user->id); ?>">  <i class="fa fa-edit"></i> 
					</a>
					<a class="btn btn-xs btn-danger" href="<?php echo e(route('delete_user',['id'=> $user->id])); ?>" class=""> <i class="fa fa-trash"></i> </a>
				</td>
			</tr>
			<!-- user Edit Modal -->
...
<?php /**PATH D:\xampp\htdocs\sbsolution\resources\views/pages/user_mangement/user_mangement_tab.blade.php ENDPATH**/ ?>