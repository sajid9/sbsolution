   <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#roleModal">  <i class="fa fa-plus"></i> Add Role
   </button>
   <!-- Modal -->
...
<table class="table table-striped table-bordered table-hover" id="dataTables-example2">
  ...
  <tbody>
    ...
    <tr class="odd gradeX">
      ...
      <?php endif; ?>
      <td>
        <a type="button" class="" data-toggle="modal" data-target="#edit<?php echo e($role->id); ?>">  <i class="fa fa-edit"></i>
        </a>
        <a href="<?php echo e(route('delete_role',['id'=> $role->id])); ?>" class=""> <i class="fa fa-trash"></i> </a>
      </td>
    </tr>
...
<?php /**PATH E:\xamp\htdocs\sb_solution\resources\views/pages/user_mangement/role_mangement_tab.blade.php ENDPATH**/ ?>