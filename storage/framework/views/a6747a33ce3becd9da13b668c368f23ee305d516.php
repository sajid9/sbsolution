         ...
         <tbody id="items_append">
          <?php $__currentLoopData = $purchase_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><i class="glyphicon glyphicon-share" onclick="returnItem('<?php echo e($receiptId); ?>','<?php echo e($item->item->id); ?>','<?php echo e($item->qty); ?>','<?php echo e($item->sale_price); ?>','<?php echo e($item->discount); ?>','<?php echo e($item->total_price); ?>')"></i><i class="glyphicon glyphicon-trash cursor" onclick='itemRemove("<?php echo e($item->id); ?>","<?php echo e($receiptId); ?>","<?php echo e($item->item->id); ?>","<?php echo e($item->qty); ?>")'></i></td>
            </tr>
