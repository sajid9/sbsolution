			    ...
			    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
			        ...
			        <tbody>
			            ...
			            <tr class="odd gradeX">
			                ...
			                <td><?php echo ($head->is_active == 'yes')? '<span class="label label-primary">active</span>' :'<span class="label label-danger">inactive</span>'; ?></td>
			                <td><a class="btn btn-xs btn-warning" href="<?php echo e(url('expenditure/edithead/'.$head->id)); ?>"><i class="fa fa-edit" title="Edit" data-toggle="tooltip"></i></a> <a class="btn btn-xs btn-success" href="<?php echo e(url('expenditure/subheadlisting/'.$head->id)); ?>"><i class="fa fa-plus" data-toggle="tooltip" title="Add Subhead"></i></a></td>
...
<?php echo $__env->make('layout.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\sb_solution\resources\views/pages/head/head_listing.blade.php ENDPATH**/ ?>