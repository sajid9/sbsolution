...
<div class="alert alert-success alert-dismissible" id="alert" style="display: none">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" tabindex="1" name="receipt_number" value="<?php echo e(old('receipt_number')); ?>" class="form-control" id="receiptnumber" aria-describedby="receipt_number" placeholder="receipt number">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" tabindex="4" disabled="" name="barcode" value="<?php echo e(old('barcode')); ?>" class="form-control" id="barcode" aria-describedby="barcode_msg" placeholder="voucher number">
            ...
            <div class="form-group">
              ...
              <input type="number" tabindex="5" disabled="" name="quantity" value="<?php echo e(old('quantity')); ?>" class="form-control" id="quantity" aria-describedby="quantity" placeholder="Quantity">
  ...
  <div class="row">
    <div class="col-md-12" style="padding-top: 20px">
      <button tabindex="7" disabled type="button" id="submit" class="btn btn-primary">Submit</button> <a href="<?php echo e(url('sale/saleorder')); ?>" class="btn btn-default">Back</a>
    </div>
  </div>
...
<?php $__env->startSection('footer'); ?>
  ...
  <script>
    ...
    $('#receiptnumber').val(getCurrentDate()+"-<?php echo e(CH::countReceipt()); ?>");
...
<?php echo $__env->make('layout.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\sb_solution\resources\views/pages/sale/add_receipt_form.blade.php ENDPATH**/ ?>