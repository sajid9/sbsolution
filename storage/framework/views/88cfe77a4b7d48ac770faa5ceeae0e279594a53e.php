         ...
         <tbody id="items_append">
          <?php $__currentLoopData = $purchase_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
              <?php if(env("BYPARTS_RECEIVING") == 'yes'): ?>
                <a href="<?php echo e(url('voucher/receivinglisting/'.$item->voucher_id.'/'.$item->item_id)); ?>"><i class="glyphicon glyphicon-plus cursor" data-toggle="tooltip" title="voucher receive"></i></a>
              <?php else: ?>
                <i class="glyphicon glyphicon-share" onclick="returnItem('<?php echo e($voucherId); ?>','<?php echo e($item->item->id); ?>','<?php echo e($item->qty); ?>','<?php echo e($item->purchase_price); ?>','<?php echo e($item->item->type); ?>')"></i>
              <?php endif; ?>
...
<?php $__env->startSection('footer'); ?>
  ...
  <script>
    ...
    function returnItem(voucherId,itemId,qty,purchasePrice,type){
      ...
      $.ajax({
          url:"<?php echo e(url('voucher/getreturnedWOR')); ?>",
          type:"post",
          dataType:"json",
          data:{_token:"<?php echo e(csrf_token()); ?>",voucher:voucherId,item:itemId},
    ...
    $('#return_form').on('submit',function(e){
        ...
        $.ajax({
          url:"<?php echo e(url('voucher/returnitemWOR')); ?>",
          type:"post",
          dataType:"json",
          data:data,
          success:function(res){
...
<?php echo $__env->make('layout.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\sb_solution\resources\views/pages/purchase/edit_voucher_form.blade.php ENDPATH**/ ?>