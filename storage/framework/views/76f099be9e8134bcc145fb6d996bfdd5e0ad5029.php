...
<div class="row" style="padding-bottom: 10px">
	<div class="col-md-12">
		<a href="<?php echo e(url('expenditure/addmonthform')); ?>" class="btn btn-social btn-bitbucket pull-right">
			    ...
			    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
			        ...
			        <tbody>
			            ...
			            <tr class="odd gradeX">
			                ...
			                <td><?php echo e($month->name); ?></td>
			                <td><?php echo ($month->is_active == 'yes')? '<span class="label label-primary">active</span>' :'<span class="label label-danger">inactive</span>'; ?></td>
			                <td><a class="btn btn-xs btn-warning" href="<?php echo e(url('expenditure/editmonth/'.$month->id)); ?>"><i class="fa fa-edit" title="Edit" data-toggle="tooltip"></i></a> </td>
...
<?php echo $__env->make('layout.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\sb_solution\resources\views/pages/month/month_listing.blade.php ENDPATH**/ ?>