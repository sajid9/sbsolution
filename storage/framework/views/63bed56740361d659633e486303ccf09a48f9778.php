<div class="panel panel-success" style="margin-top: 15px">
  ...
  <div class="panel-body">
	<form method="post" action="<?php echo e(url('user_mangement/addauthority')); ?>">
...
<?php /**PATH D:\xampp\htdocs\sb_solution\resources\views/pages/user_mangement/authority.blade.php ENDPATH**/ ?>