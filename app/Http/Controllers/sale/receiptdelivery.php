...
class receiptdelivery extends Controller
{
    public function delivery_listing($receipt,$item)
    {
    	...
    	return view('pages.sale.item_delivered.delivered_listing',compact('delivered_items'));
    }
    ...
    public function add_delivery_form($receiptId,$itemId)
    {
    	...
    	return view('pages.sale.item_delivered.add_delivered_form',compact('item'));
    }
    ...
    public function store_listing($receipt,$item,$qty,$delivery_id)
    {
        ...
        return view('pages.sale.item_delivered_store.delivered_store_listing',compact('items'));
    }
    public function add_delivery_store_form($receiptId,$itemId,$qty,$deliveryId)
    {
        $stores = stores::all();
        $item = items::find($itemId);
        return view('pages.sale.item_delivered_store.add_delivery_store_form',compact('stores','item'));
    }
