			    ...
			    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
			        ...
			        <tbody>
			            ...
			            <tr class="odd gradeX">
			                ...
			                <td><a class="btn btn-xs btn-warning" href="{{url('expenditure/editmonth/'.$month->id)}}"><i class="fa fa-edit" title="Edit" data-toggle="tooltip"></i></a> {{-- <a onclick="deleteCompany('{{$company->id}}')"><i class="fa fa-trash" data-toggle="tooltip" title="Delete"></i></a> --}}</td>
